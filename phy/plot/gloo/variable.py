...
bool        gl.GL_BOOL         1  gl.GL_BOOL         bool_
bvec2       gl.GL_BOOL_VEC2    2  gl.GL_BOOL         bool_
bvec3       gl.GL_BOOL_VEC3    3  gl.GL_BOOL         bool_
bvec4       gl.GL_BOOL_VEC4    4  gl.GL_BOOL         bool_
...
gl_typeinfo = {
    ...
    gl.GL_BOOL: (1, gl.GL_BOOL, bool_),
    gl.GL_BOOL_VEC2: (2, gl.GL_BOOL, bool_),
    gl.GL_BOOL_VEC3: (3, gl.GL_BOOL, bool_),
    gl.GL_BOOL_VEC4: (4, gl.GL_BOOL, bool_),
